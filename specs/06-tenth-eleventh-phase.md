# Building the Phase 10 and 11

You have to build the Phase 10 and 11 of the phases.md file.
...
- Dont add any new features that are not mentioned in the phases.md file.
- Dont change the existing UI/UX unless explicitly asked.

## Additional Context

The phases.md file contains the detailed specifications for each phase. Make sure to follow them exactly.
