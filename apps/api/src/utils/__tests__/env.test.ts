  ...
  it('validates env with all required fields', async () => {
    vi.stubGlobal('process', {
      ...
      env: {
        ...
        FINGERPRINT_SECRET: 'cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc',
        CSRF_SECRET: 'dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd',
        NODE_ENV: 'test',
      },
    })
